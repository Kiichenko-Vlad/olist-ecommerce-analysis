...
- [Аналіз E-Commerce платформи Olist](#аналіз-e-commerce-платформи-olist)
  - [Зміст](#зміст)
  ...
  - [Ключові візуалізації](#ключові-візуалізації)
    - [Динаміка замовлень по місяцях (Q1)](#динаміка-замовлень-по-місяцях-q1)
    - [Вплив часу доставки на оцінку клієнта (Q8)](#вплив-часу-доставки-на-оцінку-клієнта-q8)
  - [Головні висновки](#головні-висновки)
  - [Статистичні гіпотези](#статистичні-гіпотези)
  - [Як запустити](#як-запустити)
    - [1. Клонувати репозиторій](#1-клонувати-репозиторій)
    - [2. Встановити залежності](#2-встановити-залежності)
    - [3. Налаштувати змінні середовища](#3-налаштувати-змінні-середовища)
    - [4. Запустити PostgreSQL](#4-запустити-postgresql)
    - [5. Створити схему бази даних](#5-створити-схему-бази-даних)
    - [6. Завантажити датасет](#6-завантажити-датасет)
    - [7. Запустити ETL-пайплайн](#7-запустити-etl-пайплайн)
    - [8. Відкрити ноутбуки](#8-відкрити-ноутбуки)
...
│   ├── 04_analysis.ipynb            ← Cтатистичні гіпотези
